...
Issue-message relay candidate (2026-09-23): new app issue reports can be relayed as ordinary direct messages from the reporter to one configured company admin/manager. No Messages UI changes or old-report backfill. Local/testing platform only; production migration, recipient setup and publication are pending. See `APP_ISSUE_MESSAGE_RELAY.md`.
