...
- Public request photo attach probing found a live RPC hardening gap; `supabase/step-next-public-request-photo-attach-hardening.sql` has been added and must be applied before that probe can pass.
