...
- `app.js`
  ...
  - Current line count is about 6,232 after ongoing modularization work.
...
- `src/`
  ...
  - Recent examples include `src/workflows/quickFixWorkflow.js`, `src/workflows/messageWorkflow.js`, `src/workflows/preventiveMaintenanceWorkflow.js`, `src/services/authSessionFlow.js`, and render modules for Work Order Detail, Equipment Detail, Message Center, Create Work Order, and Quick Fix.
