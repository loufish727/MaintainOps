...
- 2026-05-26: LFES Parts/Equipment filter-search state slice wired to `workspaceUiState`. Static checks, state smoke, part-search smoke, inventory-filter state smoke, local resource smoke, and local boot assertion passed.
