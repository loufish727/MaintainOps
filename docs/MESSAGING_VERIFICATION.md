...
- `message-voice-confirm.spec.js`: all three composers, text-only bypass, keyboard submission, cancel/Escape, audio-only sends, stale-draft refusal, scope reset and temporary audio URL cleanup at 320px. Included in the automated release/strict browser stage.
