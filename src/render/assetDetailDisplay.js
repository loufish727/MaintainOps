(function () {
  ...
  function createAssetDetailDisplayHelpers(deps = {}) {
    ...
    function renderAssetDangerZone(asset) {
      ...
      return `<section class="delete-zone asset-delete-zone"><div><h3>Archive / Delete Equipment</h3>
        ...
        <button class="danger-action-button large-delete-button" data-archive-equipment="${escapeHtml(asset.id)}" type="button">Archive / Delete Equipment</button></section>`;
    }
