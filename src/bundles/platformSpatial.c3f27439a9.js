...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function td(){return new sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rh(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function nd(){return new sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rh(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function Rh(){return`
...
`;continue}if((X=j.match(x))&&(H.gamma=parseFloat(X[1])),(X=j.match(A))&&(H.exposure=parseFloat(X[1])),(X=j.match(W))&&(H.valid|=2,H.format=X[1]),(X=j.match(B))&&(H.valid|=4,H.height=parseInt(X[1],10),H.width=parseInt(X[2],10)),H.valid&2&&H.valid&4)break}return H.valid&2||a(3,"missing format specifier"),H.valid&4||a(3,"missing image size specifier"),H},f=function(C,b,x){let A=b;if(A<8||A>32767||C[0]!==2||C[1]!==2||C[2]&128)return new Uint8Array(C);A!==(C[2]<<8|C[3])&&a(3,"wrong scanline width");let W=new Uint8Array(4*b*x);W.length||a(4,"unable to allocate buffer space");let B=0,H=0,j=4*A,X=new Uint8Array(4),re=new Uint8Array(j),Q=x;for(;Q>0&&H<C.byteLength;){H+4>C.byteLength&&a(1),X[0]=C[H++],X[1]=C[H++],X[2]=C[H++],X[3]=C[H++],(X[0]!=2||X[1]!=2||(X[2]<<8|X[3])!=A)&&a(3,"bad rgbe scanline format");let xe=0,_e;for(;xe<j&&H<C.byteLength;){_e=C[H++];let We=_e>128;if(We&&(_e-=128),(_e===0||xe+_e>j)&&a(3,"bad scanline data"),We){let it=C[H++];for(let ee=0;ee<_e;ee++)re[xe++]=it}else re.set(C.subarray(H,H+_e),xe),xe+=_e,H+=_e}let Se=A;for(let We=0;We<Se;We++){let it=0;W[B]=re[We+it],it+=A,W[B+1]=re[We+it],it+=A,W[B+2]=re[We+it],it+=A,W[B+3]=re[We+it],B+=4}Q--}return W},g=function(C,b,x,A){let W=C[b+3],B=Math.pow(2,W-128)/255;x[A+0]=C[b+0]*B,x[A+1]=C[b+1]*B,x[A+2]=C[b+2]*B,x[A+3]=1},_=function(C,b,x,A){let W=C[b+3],B=Math.pow(2,W-128)/255;x[A+0]=fa.toHalfFloat(Math.min(C[b+0]*B,65504)),x[A+1]=fa.toHalfFloat(Math.min(C[b+1]*B,65504)),x[A+2]=fa.toHalfFloat(Math.min(C[b+2]*B,65504)),x[A+3]=fa.toHalfFloat(1)},m=new Uint8Array(e);m.pos=0;let p=d(m),v=p.width,y=p.height,S=f(m.subarray(m.pos),v,y),O,R,P;switch(this.type){case Mn:P=S.length/4;let C=new Float32Array(P*4);for(let x=0;x<P;x++)g(S,x*4,C,x*4);O=C,R=Mn;break;case xn:P=S.length/4;let b=new Uint16Array(P*4);for(let x=0;x<P;x++)_(S,x*4,b,x*4);O=b,R=xn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:v,height:y,data:O,header:p.string,gamma:p.gamma,exposure:p.exposure,type:R}}setDataType(e){return this.type=e,this}load(e,t,n,i){function r(a,o){switch(a.type){case Mn:case xn:a.colorSpace=jt,a.minFilter=zt,a.magFilter=zt,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,i)}};var ll={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};var Dn=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}},$y=new Bi(-1,1,1,-1,0,1),lu=class extends Wt{constructor(){super(),this.setAttribute("position",new dt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new dt([0,2,0,0,2,0],2))}},Ky=new lu,Yi=class{constructor(e){this._mesh=new Gt(Ky,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,$y)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}};var cl=class extends Dn{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof sn?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Xi.clone(e.uniforms),this.material=new sn({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new Yi(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}};var ga=class extends Dn{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let i=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),r.buffers.stencil.setFunc(i.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(i.EQUAL,1,4294967295),r.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),r.buffers.stencil.setLocked(!0)}},hl=class extends Dn{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}};var ul=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new ce);this._width=n.width,this._height=n.height,t=new Sn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:xn}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new cl(ll),this.copyPass.material.blending=si,this.clock=new dr}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let i=0,r=this.passes.length;i<r;i++){let a=this.passes[i];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){let o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}ga!==void 0&&(a instanceof ga?n=!0:a instanceof hl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new ce);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,i)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}};var dl=class extends Dn{constructor(e,t,n=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Ne}render(e,t,n){let i=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=i}};var Rf={name:"LuminosityHighPassShader",shaderID:"luminosityHighPass",uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Ne(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};mr.BlurDirectionX=new ce(1,0);mr.BlurDirectionY=new ce(0,1);var Cf={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    <article class="metric-card health-metric-card status-${je(n.status)}">
      ...
      <p>${je(n.basis)}${n.sampleCount?` / ${Yn(n.sampleCount)} samples`:""}</p>
    </article>
  `).join("")}function ov(s){Ie.rulesGrid.innerHTML=s.rules.map(e=>`
    <article class="rule-card">
      <h3>${je(e.title)}</h3>
      <strong>${je(e.summary)}</strong>
      <p>${je(e.detail)}</p>
    </article>
  `).join("")}function lv(s){let e=Math.max(1,...s.months.map(t=>t.added));Ie.usageChart.innerHTML=s.months.map((t,n)=>{let i=Math.max(t.added?10:0,t.added/e*184);return`
    ...
    `}).join(""),Ie.usageChart.querySelectorAll(".month-bar").forEach(t=>{t.addEventListener("click",()=>Uf(Number(t.dataset.monthIndex)))})}function hu(s){let e=s.buckets,t=Math.max(1,...s.buckets.map(n=>n.size));Ie.bucketList.innerHTML=e.map((n,i)=>{let r=Math.max(4,n.size/t*100);return`
    ...
    `}).join(""),Ie.bucketList.querySelectorAll(".bucket-card").forEach(n=>{n.addEventListener("click",i=>{i.target.closest(".bucket-source")||_s?.focusBucket(Number(n.dataset.bucketIndex))})})}function cv(s,e){return!e||`${s.name} ${s.bucket} ${s.category} ${s.equipment}`.toLowerCase().includes(e.toLowerCase())}function uu(s){let e=Ie.search.value.trim(),n=[...s.files].sort((i,r)=>r.size-i.size).filter(i=>cv(i,e));Ie.filesCount.textContent=`${n.length} shown`,Ie.fileEmpty.hidden=n.length>0,Ie.fileList.innerHTML=n.map(i=>{let r=s.files.indexOf(i);return`
    ...
    `}).join(""),Ie.fileList.querySelectorAll(".open-file").forEach(i=>{i.addEventListener("click",r=>{r.stopPropagation();let a=s.files[Number(i.dataset.fileIndex)];a&&uv(a)})}),Ie.fileList.querySelectorAll(".file-row").forEach(i=>{i.addEventListener("click",()=>_s?.focusFile(Number(i.dataset.fileIndex)))})}function hv(s){Ie.opsGrid.innerHTML=s.operations.map(e=>`
    <article class="ops-card"><span class="severity ${je(e.severity)}">${je(e.severity)}</span><h3>${je(e.title)}</h3><p>${je(e.detail)}</p></article>
  `).join("")}function uv(s){Ie.dialogTitle.textContent=s.name,Ie.dialogDetails.innerHTML=`
  ...
  `,Ie.dialog.open||Ie.dialog.showModal()}function Uf(s){Ie.timelineMonths.forEach(e=>e.classList.toggle("active",Number(e.dataset.timelineMonth)===s)),Ie.usageChart.querySelectorAll(".month-bar").forEach(e=>e.classList.toggle("active",Number(e.dataset.monthIndex)===s))}function pl(s=null){Ie.timelineSource.open=!0,Nf("timeline"),Ie.zoneIndicator.textContent="Viewing: Activity Runway",s!==null&&Uf(s),requestAnimationFrame(()=>Ie.timelineSource.scrollIntoView({behavior:"smooth",block:"start"}))}function Nf(s){Ie.stageActions.forEach(e=>{let t=e.dataset.worldTarget===s;e.classList.toggle("active",t),e.setAttribute("aria-pressed",String(t))})}function Of(s){hn=iv(s||ps),rv(hn),av(hn),ov(hn),lv(hn),hu(hn),uu(hn),hv(hn),Ie.refresh.classList.remove("refreshing");let e=Ie.refresh.querySelector("span:last-child");e&&(e.textContent="Refresh"),Ie.updated.textContent=`Sampled ${new Date(s?.sampledAt||Date.now()).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}`,Ie.timelineMonths.forEach((t,n)=>{let i=hn.months[n];t.textContent=Qy(i?.label,n),t.dataset.timelineMonth=String(n),t.hidden=!i}),_s||(_s=Pf({canvas:Ie.canvas,touchTargets:Ie.touchTargets,tooltip:Ie.tooltip,buckets:hn.buckets,months:hn.months,files:hn.files,core:hn.core,activity:hn.recentActivity,formatBytes:t=>`${Yn(t/ml)} events`,onZoneChange:t=>{Nf(t.id),Ie.zoneIndicator.textContent=`Viewing: ${t.label}`},onBucketSelected:()=>{du="all",hu(hn)},onMonthSelected:(t,n)=>pl(n),onFileSelected:()=>{},onVaultSelected:()=>{Ie.summarySource.open=!0},qualityPreference:localStorage.getItem("maintainops.performanceQuality")||"auto",onPerformanceSample:t=>{window.parent.postMessage({type:"maintainops-platform-spatial-telemetry",sample:t},gs)},onQualityChange:t=>Ff(t.preference,t.effective),onFirstRender:t=>{If||(If=!0,document.documentElement.classList.add("platform-spatial-ready"),window.__MAINTAIN_OPS_PLATFORM_SPATIAL_READY=!0,window.parent.postMessage({type:"maintainops-platform-spatial-rendered"},gs),window.parent.postMessage({type:"maintainops-platform-spatial-telemetry",sample:{...t,readyMs:performance.now()-Zy}},gs))}}))}function Ff(s,e){Ie.qualityButtons.forEach(t=>{let n=t.dataset.qualityTier===s;t.classList.toggle("active",n),t.setAttribute("aria-pressed",String(n));let i=t.dataset.qualityTier==="performance"?"Efficient":t.dataset.qualityTier==="cinematic"?"Ultra":"Auto";t.textContent=t.dataset.qualityTier==="auto"&&e?`${i}: ${e==="performance"?"Efficient":e==="cinematic"?"Ultra":"Balanced"}`:i})}function dv(){let s=Ie.refresh.querySelector("span:last-child");Ie.refresh.classList.add("refreshing"),s&&(s.textContent="Sampling"),window.parent.postMessage({type:"maintainops-platform-spatial-refresh"},gs)}function fv(){Ie.exit?.addEventListener("click",s=>{if(window.self===window.top){localStorage.setItem("maintainops.activeSection","mywork");return}s.preventDefault(),window.parent.postMessage({type:"maintainops-platform-spatial-exit"},gs)}),document.querySelectorAll("[data-bucket-filter]").forEach(s=>{s.addEventListener("click",()=>{du=s.dataset.bucketFilter,document.querySelectorAll("[data-bucket-filter]").forEach(e=>e.classList.toggle("active",e===s)),hu(hn)})}),Ie.sourcePanels.forEach(s=>s.addEventListener("toggle",()=>{s.open&&Ie.sourcePanels.forEach(e=>{e!==s&&(e.open=!1)})})),Ie.search.addEventListener("input",()=>uu(hn)),Ie.clearSearch.addEventListener("click",()=>{Ie.search.value="",Ie.search.focus(),uu(hn)}),Ie.refresh.addEventListener("click",dv),Ie.qualityButtons.forEach(s=>s.addEventListener("click",()=>{let e=s.dataset.qualityTier||"auto";localStorage.setItem("maintainops.performanceQuality",e);let t=_s?.setQuality(e);Ff(e,t?.effective||"")})),Ie.stageActions.forEach(s=>s.addEventListener("click",()=>{let e=s.dataset.worldTarget;e==="timeline"?pl():_s?.setView(e)})),Ie.timelineMonths.forEach(s=>s.addEventListener("click",()=>pl(Number(s.dataset.timelineMonth)))),window.addEventListener("keydown",s=>{if(s.altKey||s.ctrlKey||s.metaKey||s.target instanceof HTMLInputElement)return;let e=["overview","buckets","timeline","files","vault"],t=Number(s.key)-1;t<0||t>=e.length||(s.preventDefault(),e[t]==="timeline"?pl():_s?.setView(e[t]))})}window.addEventListener("message",s=>{s.origin!==gs||s.data?.type!=="maintainops-platform-spatial-snapshot"||(Lf=!0,document.documentElement.classList.remove("platform-spatial-standalone"),Of(s.data.snapshot||ps))});Ie=sv();fv();window.parent.postMessage({type:"maintainops-platform-spatial-ready"},gs);window.setTimeout(()=>{Lf||(document.documentElement.classList.add("platform-spatial-standalone"),Of(ps))},800);})();
//# sourceMappingURL=platformSpatial.c3f27439a9.js.map
