(()=>{var fe=Object.create;var Z=Object.defineProperty;var _e=Object.getOwnPropertyDescriptor;var me=Object.getOwnPropertyNames;var ve=Object.getPrototypeOf,he=Object.prototype.hasOwnProperty;var B=(r,e)=>()=>{try{return e||r((e={exports:{}}).exports,e),e.exports}catch(d){throw e=0,d}};var ge=(r,e,d,p)=>{if(e&&typeof e=="object"||typeof e=="function")for(let v of me(e))!he.call(r,v)&&v!==d&&Z(r,v,{get:()=>e[v],enumerable:!(p=_e(e,v))||p.enumerable});return r};var U=(r,e,d)=>(d=r!=null?fe(ve(r)):{},ge(e||!r||!r.__esModule?Z(d,"default",{value:r,enumerable:!0}):d,r));var H=B(($e,V)=>{(function(){function r({escapeHtml:e,assetTypeLabel:d,parentAssetFor:p,getAssets:v,getAssetDocumentsByAssetId:h,getAssetFinancialsByAssetId:l,getAssetFinancials:y,getAssetFinancialsReady:k,getProfilesByUserId:x,getLocations:N,matchesActiveLocation:f,getFinancialPage:c,getFinancialMissingFilter:b,getFinancialLocationFilter:m,getFinancialTypeFilter:C,getFinancialAreaFilter:w,canEditFinancialRecords:q,ASSETS_PER_PAGE:j}){let o=j||12,O=c||(()=>1),S=q||(()=>!0),E=["acquisition_cost","current_book_value"],D=["asset_tag","acquisition_date","acquisition_cost","depreciation_method","useful_life_years","current_book_value","tax_jurisdiction","ownership_status","in_service_date","gl_account_code","cost_center"],L={machine:10,traveling_machine:15,forklift:20,secondary_machine:30,tooling:40,component:50,shop_item:60};function Q(n){return(h()[n]||[]).filter(t=>String(t.content_type||"").startsWith("image/")||t.document_type==="machine_photo"||t.document_type==="nameplate")}function te(n){return l?.()[n]||{}}function F(n){return n?.financialRecord||te(n?.id)}function I(n){return!!(n?.financialRecord&&!n.financialRecord.asset_id)}function M(n){let t=F(n);return D.some(s=>t[s]==null||String(t[s]).trim()==="")}function T(n){return N?.().find(t=>t.id===n)?.name||""}function Y(n){return n.reviewed_by?x?.()[n.reviewed_by]?.full_name||`User ${String(n.reviewed_by).slice(0,8)}`:""}function J(n){return n.operational_deleted_by?x?.()[n.operational_deleted_by]?.full_name||`User ${String(n.operational_deleted_by).slice(0,8)}`:""}function ae(n){return{id:`financial:${n.id}`,financialRecord:n,name:n.archived_asset_name||"Deleted equipment",asset_type:n.archived_asset_type||"machine",asset_code:n.archived_asset_code||"",asset_tag:n.archived_asset_tag||"",manufacturer:n.archived_manufacturer||"",model:n.archived_model||"",location_id:n.archived_location_id||"",location:n.archived_location||"",status:"offline"}}function W(){let n=v(),t=(y?.()||[]).filter(s=>!s.asset_id).map(ae);return[...n,...t]}function K(){let n=b?.()||"all",t=m?.()||"all",s=C?.()||"all",i=w?.()||"all";return W().filter(a=>t==="all"||a.location_id===t).filter(a=>s==="all"||(a.asset_type||"machine")===s).filter(a=>i==="all"||String(a.location||"").trim()===i).filter(a=>n==="missing"?M(a):n==="review"?F(a).needs_review===!0:!0).sort((a,_)=>{let g=(L[a.asset_type||"machine"]||999)-(L[_.asset_type||"machine"]||999);return g||String(p(a)?.name||"").localeCompare(String(p(_)?.name||""))||String(T(a.location_id)||a.location||"").localeCompare(String(T(_.location_id)||_.location||""))||String(a.location||"").localeCompare(String(_.location||""))||String(a.name||"").localeCompare(String(_.name||""))})}function A(n){return n?String(n).slice(0,10):""}function ie(n){return n==null||n===""?"":String(n)}function $(n,t){return E.includes(t)?ie(n[t]):n[t]||""}function se(n){let t=F(n),s=I(n);return`
      ...
      `}function oe(n){return n==null||n===""?"Not recorded":String(n)}function ce(n){return n?String(n).replace(/\b\w/g,t=>t.toUpperCase()):""}function re(n){let t=F(n);return`
        <div class="financial-readonly-list relationship-detail asset">
          ${[["Asset tag / fixed asset number",t.asset_tag],["Acquisition date",A(t.acquisition_date)],["Acquisition cost",$(t,"acquisition_cost")],["Depreciation method",t.depreciation_method],["Useful life years",t.useful_life_years],["Current book value",$(t,"current_book_value")],["Tax jurisdiction / property tax location",t.tax_jurisdiction],["Ownership status",ce(t.ownership_status)],["In service date",A(t.in_service_date)],["Disposal date",A(t.disposal_date)],["GL / account code",t.gl_account_code],["Cost center / department",t.cost_center],["Disposal notes",t.disposal_notes],["Finance notes",t.finance_notes],["Needs review",t.needs_review?"Yes":"No"],["Last reviewed",t.last_reviewed_at?new Date(t.last_reviewed_at).toLocaleString():""],["Reviewed by",Y(t)]].map(([i,a])=>`
            <div class="meta-row financial-readonly-row">
              <span><strong>${e(i)}</strong>${e(oe(a))}</span>
            </div>
          `).join("")}
        </div>
      `}function X(n){let t=p(n),s=Q(n.id),i=F(n),a=M(n),_=I(n);return`
        <article class="asset-card asset-state-${e(n.status||"running")} financial-asset-card ${_?"financial-asset-deleted":""}" data-open-financial-asset="${e(n.id)}" tabindex="0" role="button" aria-label="Open financial details for ${e(n.name||"equipment")}">
          <div class="part-card-main">
            ...
            <div class="chip-row">
              ...
              ${s.length?`<span class="chip">${s.length} photo${s.length===1?"":"s"}</span>`:'<span class="chip">photo missing</span>'}
      ...
      `}function le(n){let t=b?.()||"all",s=m?.()||"all",i=C?.()||"all",a=w?.()||"all",_=N?.()||[],g=W(),R=[...new Set(g.map(u=>String(u.location||"").trim()).filter(Boolean))].sort((u,P)=>u.localeCompare(P)),pe=[...new Set(g.map(u=>u.asset_type||"machine"))].sort((u,P)=>(L[u]||999)-(L[P]||999));return`
        <div class="asset-area-filter relationship-detail asset" aria-label="Financial asset filters">
          ...
          <label>Facility
            <select data-financial-filter="location">
              <option value="all" ${s==="all"?"selected":""}>All facilities</option>
              ${_.map(u=>`<option value="${e(u.id)}" ${s===u.id?"selected":""}>${e(u.name||"Location")}</option>`).join("")}
            </select>
          </label>
      ...
      `}function de(n){let t=W().find(R=>R.id===n||R.financialRecord?.asset_id===n);if(!t)return`
        ...
        `;let s=p(t),i=Q(t.id),a=F(t),_=M(t),g=I(t);return`
        <div class="queue-context-card asset-command-summary">
          ...
          <div class="team-actions">
            <button class="secondary-button back-action-button" data-back-financial-list type="button">Back to Financial</button>
            ${g?"":`<button class="secondary-button asset-action-button" data-open-financial-equipment="${e(t.id)}" type="button">Open Equipment Page</button>`}
          </div>
        </div>
        ${g?`
        ...
        <section class="relationship-detail asset">
          <div class="chip-row">
            <span class="chip">${e(s?`Part of ${s.name}`:"Top level equipment")}</span>
      ...
      `}function ue(){let n=K(),t=Math.max(1,Math.ceil(n.length/o)),s=Math.min(Math.max(Number(O())||1,1),t),i=n.slice((s-1)*o,s*o),a=(s-1)*o+1,_=Math.min(n.length,s*o),g=n.length<=o?"":`
        <div class="pagination-bar">
          <button class="secondary-button page-action-button" data-financial-page="prev" type="button" ${s<=1?"disabled":""}>Previous</button>
          <span>Showing ${a}-${_} of ${n.length} - Page ${s} of ${t}</span>
          <button class="secondary-button page-action-button" data-financial-page="next" type="button" ${s>=t?"disabled":""}>Next</button>
        </div>
      `;return`
        <div class="queue-context-card asset-command-summary">
          <div>
