(()=>{var re=Object.create;var C=Object.defineProperty;var ce=Object.getOwnPropertyDescriptor;var de=Object.getOwnPropertyNames;var ue=Object.getPrototypeOf,pe=Object.prototype.hasOwnProperty;var me=(s,o)=>()=>{try{return o||s((o={exports:{}}).exports,o),o.exports}catch(u){throw o=0,u}};var be=(s,o,u,f)=>{if(o&&typeof o=="object"||typeof o=="function")for(let m of de(o))!pe.call(s,m)&&m!==u&&C(s,m,{get:()=>o[m],enumerable:!(f=ce(o,m))||f.enumerable});return s};var fe=(s,o,u)=>(u=s!=null?re(ue(s)):{},be(o||!s||!s.__esModule?C(u,"default",{value:s,enumerable:!0}):u,s));var D=me((ye,k)=>{(function(){function s({getProfilesByUserId:o,getCurrentUser:u,getCompanyMembers:f,getTeamInvites:m,getTeamInvitesReady:b,getTeamInviteCancelError:c,getPendingCancelInviteId:j,getTeamInviteLinks:S,getTeamInviteLinksReady:A,getTeamInviteLinkError:O,getPendingRevokeInviteLinkId:I,getRequestNotificationRecipients:N,getRequestNotificationRecipientsReady:T,getRequestNotificationRecipientError:E,getSession:_,getLocations:v,getActiveCompanyMembership:W,matchesSearch:U,escapeHtml:t,roleDescription:P,roleLabel:$,normalizeRole:L,teamMemberWorkload:F,canManageTeam:ve,canAdministerTeamRoles:R,teamRoleOptionsForActor:z,COMPANY_ROLES:J,renderLocationOptions:x,inviteDefaultLocationLabel:K,teamInviteSignupUrl:Y,teamJoinUrl:G}){let y=R||(()=>!1),M=z||(()=>J),V=R||(()=>!1);function g(e){return v().find(n=>n.id===e)?.name||"Default location"}function q(e){return W?.()?.default_location_id||e||v()[0]?.id||""}function Q(e){let n=o()[e],i=u();return e===i?.id?n?.full_name||i?.email||"Me":n?.full_name||e}function X(){return f().filter(e=>U([e.user_id,e.role,o()[e.user_id]?.full_name]))}function Z({id:e,label:n,content:i,meta:r="",open:d=!1}){return`
      ...
      `}function B(e){let n=o()[e.user_id],i=_().user,r=e.user_id===i.id,d=M(e.role),a=y()&&!r&&d.length>1,p=F(e.user_id);return`
      ...
      `}function H(){let e=_().user,n=o()[e.id]||{};return`
      ...
      `}function te(e){return e.location_id?v().find(i=>i.id===e.location_id)?.name||"Unknown location":"All locations"}function ne(e){let n=T(),i=N(),r=v(),d=V();return`
      ...
      `}function ie(e){let n=b(),i=v(),r=M(),d=y(),a=q(e);return`
      ...
      `}function oe(){let e=m().filter(i=>!i.accepted_at),n=Y();return`
      ...
      `}function ae(e){let n=A(),i=S(),r=v(),d=y(),a=q(e),p=d?["technician","manager"]:["technician"],h=Date.now();return`
        <section class="team-invites">
          <div class="panel-header compact">
            <h3>Join Links</h3>
      ...
      `}return{teamMemberName:Q,filteredMembers:X,renderTeamSection:Z,renderMember:B,renderMyProfileForm:H,renderPasswordChangeForm:ee,renderRequestNotificationRecipients:ne,renderTeamInviteForm:ie,renderTeamInvites:oe,renderTeamInviteLinks:ae}}window.MaintainOpsTeamMemberDisplay={createTeamMemberDisplayHelpers:s},typeof k<"u"&&(k.exports={createTeamMemberDisplayHelpers:s})})()});var ge=fe(D());(function(){function s(o){function u(f){let b=o.getWorkOrders().filter(c=>o.matchesActiveLocation(c)&&o.isWorkOrderAssignedToUser(c,f));return{newWork:b.filter(c=>c.status==="open").length,inProgress:b.filter(c=>c.status==="in_progress").length,blocked:b.filter(c=>c.status==="blocked").length,completed:b.filter(c=>c.status==="completed").length,overdue:b.filter(c=>o.getDueState(c)?.className==="overdue").length}}return{teamMemberWorkload:u}}window.MaintainOpsTeamWorkloadDisplay={createTeamWorkloadDisplayHelpers:s}})();})();
//# sourceMappingURL=teamFeature.c03c96163b.js.map
