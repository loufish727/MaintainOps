-- Live role correction: Louie Andrade should be a manager in Taylor Metal Products.
--
-- This reverses the prior technician correction after the requested role was
-- clarified. It is scoped to the canonical Taylor Metal Products company used
-- by the Salem team.
