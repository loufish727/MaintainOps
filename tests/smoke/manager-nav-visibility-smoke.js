...
assert.match(visibleNavSource, /\["mywork", "My Work"\][\s\S]*\["work", "Work Orders"\][\s\S]*\["conversions", "Conversions"\]/);
assert.doesNotMatch(
...
assert.ok(performanceIndex > settingsIndex, "Performance should follow Settings in the section menu");
