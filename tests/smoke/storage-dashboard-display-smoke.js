...
assert.match(html, /Photos are automatically resized before upload/);
assert.match(html, /Stored at 768px, target near 256 KB/);
...
assert.match(html, /Automatically resized to 1200px when possible/);
assert.doesNotMatch(html, /blocked only if/);
